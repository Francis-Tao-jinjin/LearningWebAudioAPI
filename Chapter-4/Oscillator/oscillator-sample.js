 ...
 */
var Oscillator = [ 'sine', 'square', 'sawtooth', 'triangle' ];
var current_type = Oscillator[0];
...
OscillatorSample.prototype.play = function() {
  ...
  this.oscillator.type = current_type;
...
OscillatorSample.prototype.changeType = function(type) {
  ...
  current_type = Oscillator[type];
  if (!this.oscillator) {
    return;
  }
  this.oscillator.type = current_type; // Oscillator[type];
};
