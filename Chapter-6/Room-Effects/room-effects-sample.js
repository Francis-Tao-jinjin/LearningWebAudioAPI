...
function RoomEffectsSample(inputs) {
  ...
  var loader = new BufferLoader(context, [
    "http://orm-other.s3.amazonaws.com/webaudioapi/samples/room-effects/speech.mp3",
    "http://orm-other.s3.amazonaws.com/webaudioapi/samples/room-effects/telephone.wav",
    "http://orm-other.s3.amazonaws.com/webaudioapi/samples/room-effects/muffler.wav",
    "http://orm-other.s3.amazonaws.com/webaudioapi/samples/room-effects/spring.wav",
    "http://orm-other.s3.amazonaws.com/webaudioapi/samples/room-effects/echo.wav"
  ], onLoaded);
