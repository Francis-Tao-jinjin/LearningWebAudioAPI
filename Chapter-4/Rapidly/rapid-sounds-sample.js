...
function RapidSoundsSample(context) {
  ...
  var loader = new BufferLoader(
                          context, 
                          ['http://orm-other.s3.amazonaws.com/webaudioapi/samples/rapid-sounds/m4a1.mp3', 
                          'http://orm-other.s3.amazonaws.com/webaudioapi/samples/rapid-sounds/m1-garand.mp3'], 
                          onLoaded);
