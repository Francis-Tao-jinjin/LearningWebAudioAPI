...
function Field(canvas) {
  ...
  this.manIcon.src = 'http://orm-other.s3.amazonaws.com/webaudioapi/samples/spatialized/man.svg';
  this.speakerIcon = new Image();
  this.speakerIcon.src = 'http://orm-other.s3.amazonaws.com/webaudioapi/samples/spatialized/speaker.svg';
...
function SpatializedSample(el) {
  ...
  loadSounds(this, {
    buffer: 'http://orm-other.s3.amazonaws.com/webaudioapi/samples/spatialized/position.wav'
  });
